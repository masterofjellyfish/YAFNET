...
namespace YAF.Data.MySql
{
    ...
    {
        public const string ProviderTypeName = "System.Data.MySqlClient";
        ...
        /// </param>
        public MySqlDbAccess([NotNull] Func<string, DbProviderFactory> dbProviderFactory, IProfileQuery profiler)
            : base(dbProviderFactory, profiler, new MySqlDbInformation())
        {
        }
