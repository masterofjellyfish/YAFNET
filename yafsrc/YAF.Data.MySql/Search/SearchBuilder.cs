...
namespace YAF.Data.MySql.Search
{
    ...
    public class SearchBuilder
    {
        ...
        public string BuildSearchSql([NotNull] ISearchContext context)
        {
            ...
            searchSql +=
                "\r\nFROM {objectQualifier}topic a LEFT JOIN {objectQualifier}message c ON a.TopicID = c.TopicID LEFT JOIN {objectQualifier}user b on c.UserID = b.UserID join {objectQualifier}vaccess x on x.ForumID=a.ForumID ";
            searchSql +=
            ...
            {
                builtStatements.Add("LIMIT {0};".FormatWith(context.MaxResults));
            }
